...
public class CourtManagementViewModel extends ViewModel {
    ...
    private final MutableLiveData<String> error = new MutableLiveData<>(); // LiveData for error messages
    ...
    public void loadNextPage() {
        ...
        yardRepository.fetchYardsByPage(currentPage, new ApiCallback<List<YardResponseDTO>>() {
            ...
            public void onError(Throwable error) {
                Log.e("CourtManagementViewModel", "Error loading yards: " + error.getMessage());
                CourtManagementViewModel.this.error.postValue("Error loading yards: " + error.getMessage());
            }
        });
    }
    ...
    public void loadYardsByHostId() {
        yardRepository.fetchYardsByHostId(hostId, new ApiCallback<List<YardResponseDTO>>() {
            ...
            public void onError(Throwable error) {
                ...
                CourtManagementViewModel.this.error.postValue("Error loading yards by host ID: " + error.getMessage());
            }
        });
    }
    ...
    public void createYard(YardRequestDTO yardRequestDTO) {
        yardRepository.createYard(yardRequestDTO, new ApiCallback<YardResponseDTO>() {
            ...
            public void onSuccess(YardResponseDTO result) {
                Log.d("CourtManagementViewModel", "Yard created successfully: " + result);
            ...
            public void onError(Throwable error) {
                ...
                CourtManagementViewModel.this.error.postValue("Error creating yard: " + error.getMessage());
            }
        });
    }
